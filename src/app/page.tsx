        ...
        <main className="flex flex-col gap-y-4 items-center sm:items-start">
          <div className="flex items-start self-stretch gap-x-4 w-full">
            <div className="flex flex-col items-start justify-center gap-y-6 px-16 py-20 bg-white rounded-xl self-stretch">
              <div className="flex flex-col items-start gap-y-6">
                <h1 className="font-medium text-5xl text-[#121212]">
                  Memoify Graduation Digital Album for Business
                </h1>
                <p className="font-normal text-lg text-[#667085]">
                  You capture once-in-a-lifetime moments. We help you deliver
                  them in a way that keeps your name remembered and shared, long
            ...
            <div className="w-full max-w-[619px]">
              <Image
                src="https://res.cloudinary.com/dqipjpy1w/image/upload/v1755315013/Image_k8bvnt.png"
                alt="Image Hero"
                width={619}
                height={747}
          ...
          <div className="w-full flex flex-col items-center pt-16 justify-center gap-y-[45px] bg-[#45090A] overflow-hidden rounded-xl">
            <div className="flex flex-col items-center text-center gap-y-4 w-full max-w-[659px]">
              <h2 className="font-medium text-[40px] leading-[120%] text-white">
                Great photos deserve more than a download link
              </h2>
              <p className="font-normal text-lg text-white">
                You&apos;ve worked hard to capture the perfect shot, lighting,
                timing, emotion. But after the shoot, most clients get a simple
                link in their inbox.
              </p>
            </div>
            <Image
              src="https://res.cloudinary.com/dqipjpy1w/image/upload/v1755316480/Image_1_xzmf24.png"
              alt="Image Hero"
              width={983.98}
              height={479.11}
            />
